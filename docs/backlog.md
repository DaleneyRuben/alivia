...
- [ ] Locations (Ubicaciones): list, add, edit ([§8](flows/doctor-assistant-panel.md))
- [ ] Locations: remove with warning when Schedule blocks exist (blocks deleted, availability stops) ([§8](flows/doctor-assistant-panel.md))
