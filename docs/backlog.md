...
- [ ] Marking Attended by the Doctor (opted in) triggers the Diagnosis Entry flow; first Attended visit also creates the Medical Profile ([§1, §4](flows/domain-lifecycles.md)) 🚧 fix/attended-gates-diagnosis-entry
